  ...
  return (
    ...
    <div className='grid grid-cols-5 md:grid-cols-2 p-[4%] gap-6'>
      ...
      <div className='col-span-2'>
        ...
        <p className='text-lg pt-5 text-blue-gray-600'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus magni sed, laudantium sequi quod nostrum non eum! Laudantium, pariatur? Nulla, hic. Est, nihil autem culpa fuga nulla possimus tempore beatae.</p>
      </div>
      ...
      <div className='text-left text-lg '>
        <ul className='text-blue-gray-600'>
            ...
            <li className='font-bold text-black pb-3'>
              <NavLink to="/"  className="hover:text-orange-300 duration-200" >MealDB</NavLink>
            </li>
    ...
    <div>
        ...
        <p className='px-[5%] pb-6'>© 2023 MealDB - All rights reserved</p>
    </div>
